...
//		nvram_set_int("led_2g_gpio", 72|GPIO_ACTIVE_LOW);
	...
	case MODEL_RTAC1200GP:
		...
		nvram_set("wl1_vifnames", "wl1.1 wl1.2 wl1.3");
		//PhicomK2P
		nvram_set_int("btn_rst_gpio", 4103|GPIO_ACTIVE_LOW);
		nvram_set_int("btn_wps_gpio", 4105|GPIO_ACTIVE_LOW);
		nvram_set_int("led_pwr_gpio", 4099);
		//nvram_set_int("led_wps_gpio", 255);
//		nvram_set_int("led_5g_gpio", 11);	// active high
		nvram_set_int("led_usb_gpio", 255);
...
//		nvram_set_int("led_5g_gpio", 11);	// active high
		...
		nvram_set("ohci_ports", "2-1");
//		if (!nvram_get("ct_max"))
			nvram_set("ct_max", "300000"); //Phicom

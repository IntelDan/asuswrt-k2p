...
if(bwdpi_support){	
	if(traffic_analyzer_support){	/* untranslated #Traffic_Analyzer# */
		if(wtfast_support){
			menuL1_title = new Array("", "<#menu1#>", "<#Guest_Network#>", AiProtection_title_add_br, Adaptive_QoS_add_br, "<#Game_Boost#>", "<#Traffic_Analyzer#>" ,"<#Menu_usb_application#>", AiCloud_Title_add_br, "<#Tool_Box#>", "<#menu5#>");
			menuL1_link = new Array("", "index.asp", "Guest_network.asp", "AiProtection_HomeSecurity.asp", "AdaptiveQoS_Bandwidth_Monitor.asp", "GameBoost.asp", "TrafficAnalyzer_Statistic.asp", "APP_Installation.asp", "cloud_main.asp", "Tools_Sysinfo.asp", "");
		}
		else{
			menuL1_title = new Array("", "<#menu1#>", "<#Guest_Network#>", AiProtection_title_add_br, Adaptive_QoS_add_br, "<#Traffic_Analyzer#>" ,"<#Menu_usb_application#>", AiCloud_Title_add_br, "<#Tool_Box#>", "<#menu5#>");
		...
		if(wtfast_support){		
			menuL1_title = new Array("", "<#menu1#>", "<#Guest_Network#>", AiProtection_title_add_br, Adaptive_QoS_add_br, "<#Game_Boost#>", "<#Menu_usb_application#>", AiCloud_Title_add_br, "<#Tool_Box#>", "<#menu5#>");
			...
			menuL1_title = new Array("", "<#menu1#>", "<#Guest_Network#>", AiProtection_title_add_br, Adaptive_QoS_add_br, "<#Menu_usb_application#>", AiCloud_Title_add_br, "<#Tool_Box#>", "<#menu5#>");
	...
	if(wtfast_support){	
		menuL1_title = new Array("", "<#menu1#>", "<#Guest_Network#>", "<#Menu_TrafficManager#>", "<#Parental_Control#>", "<#Game_Boost#>", "<#Menu_usb_application#>", AiCloud_Title_add_br, "<#Tool_Box#>", "<#menu5#>");
		...
		menuL1_title = new Array("", "<#menu1#>", "<#Guest_Network#>", "<#Menu_TrafficManager#>", "<#Parental_Control#>", "<#Menu_usb_application#>", AiCloud_Title_add_br, "<#Tool_Box#>", "<#menu5#>");
